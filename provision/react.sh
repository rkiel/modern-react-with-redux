...
npm install react-router --save >/dev/null 2>&1
...
echo "  chai"
npm install chai --save-dev >/dev/null 2>&1
echo "  chai-jquery"
npm install chai-jquery --save-dev >/dev/null 2>&1
echo "  jquery"
npm install jquery --save-dev >/dev/null 2>&1
echo "  jsdom"
npm install jsdom --save-dev >/dev/null 2>&1
echo "  mocha"
npm install mocha --save-dev >/dev/null 2>&1
echo "  react-addons"
npm install react-addons-test-utils --save-dev >/dev/null 2>&1
echo "  webpack"
